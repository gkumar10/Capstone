...
#txt <- c("This is the first document.", "This is the second file.", "This is the third text.", "you're great", "isn't it")
head(txt, 100)
...
barplot(head(ngram2, 25), 
        ...
        las=2,
        col="blue", xlim=c(0,0), ylim=c(0,0))
#rm(ngram2)
```
...
barplot(head(ngram3, 25), 
        ...
        las=2,
        col="green", xlim=c(0,0), ylim=c(0,0))
#rm(ngram3)
```
...
print(paste(i, "words with", cover50, "instances cover 50% of", sum(ngram1$Freq), "words in the text dataset."))
...
print(paste(i, "words with", cover90, "instances cover 90% of", sum(ngram1$Freq), "words in the text dataset."))
...
wordcloud (words=head(ngram1$ngram1, 25), freq=head(ngram1$Freq, 25), colors=brewer.pal(8, "Dark2"), scale=c(5, 0.10))
```
