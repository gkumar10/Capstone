...
blogs <- readLines("~/Coursera/CapstoneData/final/en_US/en_US.blogs.txt", skipNul=TRUE) #original Blogs file
news <- readLines("~/Coursera/CapstoneData/final/en_US/en_US.news.txt", skipNul=TRUE) #original News file
twitter <- readLines("~/Coursera/CapstoneData/final/en_US/en_US.twitter.txt", skipNul=TRUE) #original Twitter file
...
ngram2 <- NGramTokenizer(txt, Weka_control(min=2, max=2))
